...
export async function checkIsHoneyPot(poolData) {
    try {
...
async function analyzeSellHistory(tokenType) {
    try {
    ...
    if (_coin) {
        ...
        if (moveModule) {
            ...
            if (_f) {
                ...
                if (exposedFunctions.migrate_regulated_currency_to_v2)
                    return true;
            }
            if (_f2) {
...
//# sourceMappingURL=checkIsHoneyPot.js.map