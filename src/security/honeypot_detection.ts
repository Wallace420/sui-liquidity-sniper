...
export async function checkIsHoneypot(coin: string): Promise<HoneypotCheckResult> {
  try {
...
async function performAdditionalChecks(coin: string): Promise<HoneypotCheckResult> {
  try {
    // Hole Token-Besitzer
